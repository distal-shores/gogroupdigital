...
function theme_enqueue_jquery() {
	...
	// Get Latest Version
	$url = $protocol . '://code.jquery.com/jquery-3.2.1.min.js';

	// Setup WordPress URI
	$wpurl =  get_bloginfo('template_directory') . '/js/jquery-3.2.1.min.js';
	...
	wp_enqueue_script( 'Theme', get_bloginfo('template_directory') . '/' . $script_location , array('jquery'), '1.0', true );
	...
	wp_localize_script('basic', 'themeWP', $wp_object);
