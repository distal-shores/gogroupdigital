<?php
	 ...
	 * ### Usage:
	 * ```php
	 * $image = theme_get_acf_image($image, $size, $classes);
	 * if ( $image ) {
	 *	echo $image;
	 * }
	 * ```
	 ...
	 *
	 */
	function theme_get_acf_image($image, $size = 'thumbnail', $classes = '') {
	...
	/**
	 * Echos the output from theme_get_acf_image, which returns html for an ACF image
	 *
	 * ### Usage:
	 * ```php
	 * theme_acf_image(get_field('photo'), 'large', 'fancy_class');
	 * ```
	 *
	 * @package theme
	 * @subpackage boilerplate-theme
	 ...
	 * @param string $size 					Image size
	 * @param string $classes 				Classes to be added
	 * @uses theme_get_acf_image()
	 * @link http://www.advancedcustomfields.com/resources/image/
	 *
	 */
	function theme_acf_image($image, $size = 'thumbnail', $classes = '') {
	 ...
	 * <code>
	 * $image = theme_get_post_thumbnail_url();
	 * </code>
	 *
	 * For the 'thumbnail' size of another post:
	 * <code>
	 * $image = theme_get_post_thumbnail_url('thumbnail', 13);
	 * </code>
	 *
	 * For the full image of another post:
	 * <code>
	 * $image = theme_get_post_thumbnail_url('full', 13);
	 * </code>
	 *
	 * @package theme
	 * @subpackage boilerplate-theme
	 ...
	 */
	function theme_get_post_thumbnail_url($size='', $id = false) {
