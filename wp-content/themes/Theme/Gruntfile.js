      ...
      all: {
        files: {
          'js/dist/application.js': [
            ...
            'js/src/vendor/lazysizes.min.js',
            'js/src/vendor/scrollreveal.min.js',
            'js/src/app.js',
            'js/src/modules/menu.js',
            'js/src/modules/modernizr-uses.js',
            'js/src/modules/scroll_and_reveal.js',
            'js/src/modules/header.js',
            'js/src/modules/contact-form.js',
            'js/src/modules/scrollTo.js',
          ]
        }
      }
    },
